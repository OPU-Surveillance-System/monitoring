...
domain =[{'name': 'tmax', 'type': 'continuous', 'domain': (0.0005, 1)},
         {'name': 'tmin', 'type': 'continuous', 'domain': (0.0005, 1)}]
...
optimizer.plot_convergence(filename="/home/scom/pictures/bayesian_optimization/prior_convergence_iteration%.03i.png" % (0))
n_iter = 20
print("Start optimization")
t_start = time.time()
for i in range(n_iter):
    optimizer.run_optimization(max_iter=1, eps=0.00125)
    optimizer.plot_acquisition(filename="/home/scom/pictures/bayesian_optimization/posterior_acquisition_iteration%.03i.png" % (i+1))
    optimizer.plot_convergence(filename="/home/scom/pictures/bayesian_optimization/posterior_convergence_iteration%.03i.png" % (i+1))
    t_end = time.time()
