...
def test(fi, be, al, it):
    ...
    def cout(Liste):
        ...
        l = [distance(Liste[i],Liste[i+1]) for i in range(0,len(Liste)-1)]
        return sum(l)
    ...
    def coutTotal(ListeDeListe):
        ...
        #for Liste in ListeDeListe:
            #c = c + cout(Liste)
        l = [cout(Liste) for Liste in ListeDeListe]
        return sum(l)
    ...
    def coutTotalMulti(Drones):
        ...
        #for Drone in Drones:
            #c = c + coutTotal(Drone)
        l = [coutTotal(Drone) for Drone in Drones]
        return sum(l)
    ...
    def incertitudeTotaleMulti(Drones):
        ...
        l = [incertitudeTotale(Drone) for Drone in Drones]
    ...
    def longueur(ListeDeListe):
        ...
        #for Liste in ListeDeListe:
            #l = l + len(Liste)
        l = [len(Liste) for Liste in ListeDeListe]
        return sum(l)
    ...
    def fusionnerMulti(Drones):
        ...
        routesCompletes = [fusionner(Drone) for Drone in Drones]
    ...
    def diviserMulti(Drones):
        ...
        routes = [diviser(Drone) for Drone in Drones]
        return routes
...
bounds = [{'name': 'var_1', 'type': 'continuous',  'domain': (0.2,1)},       # Firefly
                ...
                {'name': 'var_3', 'type': 'continuous', 'domain': (0.2,0.3)}]          # Alpha
